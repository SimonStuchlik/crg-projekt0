...
public class prihlasovanie extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextmeno, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 200, 110, 30));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 220, 120, -1));
        ...
        getContentPane().add(jButtonucitel, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 320, -1, 30));
        getContentPane().add(jPasswordField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 250, 110, 30));

        jLabel2.setFont(new java.awt.Font("Showcard Gothic", 1, 14)); // NOI18N
        jLabel2.setText("meno");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 200, 80, 30));

        jLabel3.setFont(new java.awt.Font("Showcard Gothic", 1, 14)); // NOI18N
        jLabel3.setText("heslo");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 260, 90, -1));
        ...
        jButton2.setText("nemam ucet");
        jButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton2ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 260, 120, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\PC\\Pictures\\Camera Roll\\ii2.jpg")); // NOI18N
 ...
 nemamucet nemamucet = new nemamucet(); // Zadefinuje Jframe(Domov)
            nemamucet.show(); // Zobrazí Jframe(Domov)
